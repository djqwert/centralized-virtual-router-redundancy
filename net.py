...
def myNetwork():
    ...
    info( '*** Add hosts\n')
    h1 = net.addHost('h1', cls=Host, ip='10.0.2.3/24')
    h2 = net.addHost('h2', cls=Host, ip='10.0.2.4/24')
    h3 = net.addHost('h3', cls=Host, ip='10.0.2.5/24')
    ...
    net.addLink(h2, s1)
    net.addLink(h3, s1)
    net.addLink(s1, r1, intfName2='eth0', params2={ 'ip' : '10.0.2.1/24' })
    net.addLink(s1, r2, intfName2='eth0', params2={ 'ip' : '10.0.2.2/24' })
    net.addLink(s2, r1, intfName2='eth1', params2={ 'ip' : '10.0.3.1/24' })
    net.addLink(s2, r2, intfName2='eth1', params2={ 'ip' : '10.0.3.2/24' })
    net.addLink(s2, h4)
    net.addLink(s2, h5)
    net.addLink(s2, h6)
